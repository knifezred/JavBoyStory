...
define gui.accent_color = '#6c5ce7'
...
## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#a29bfe'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，会
## 处于选中状态。
define gui.selected_color = '#6c5ce7'
...
## 用。
define gui.muted_color = '#6c5ce7'
define gui.hover_muted_color = '#686de0'

## 对话和菜单选择文本使用的颜色。
define gui.text_color = '#18a058'
define gui.interface_text_color = '#18a058'


## 字体和字体大小 #####################################################################

## 游戏内文本使用的字体。
define gui.text_font = "gui/fonts/HarmonyOS_Sans_SC_Regular.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "gui/fonts/HarmonyOS_Sans_SC_Regular.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "gui/fonts/HarmonyOS_Sans_SC_Regular.ttf"
...
## 标题菜单和游戏菜单使用的图像。
define gui.main_menu_background = "gui/game_menu.webp"
...
## 通用框架。
define gui.frame_borders = Borders(2, 3, 3, 3)
